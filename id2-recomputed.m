...
prob=optimproblem('Objective', 2*(2*x1c+x2c+2*x3c)+15*(2*x1b+x2b+2*x3b), 'ObjectiveSense', 'minimize');
% Add constraints to the optimization problem
prob.Constraints.c1=2*x1c+x2c+2*x3c>=2500;
prob.Constraints.c2=2*x1b+x2b+2*x3b>=406;
